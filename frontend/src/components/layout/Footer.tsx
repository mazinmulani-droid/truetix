  ...
  return (
    <footer className="border-t border-border bg-background py-10 mt-auto">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 className="font-bold text-lg mb-4 text-primary">TrueTix</h3>
          <p className="text-sm text-muted-foreground">
            Experience world-class cinema and live event ticketing with state-of-the-art screens,
            instant seat locking, and exceptional service.
          </p>
        </div>
        <div>
          <h4 className="font-semibold mb-4">TrueTix Experience</h4>
